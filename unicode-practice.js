...
// Task 2
let ucode = [72, 101, 108, 108];
wordFromCodePoints = String.fromCharCode(...ucode);// Your code here

// Task 3
let inputString2 = "Launch";
let firstLetter = inputString2.charCodeAt(0);
let lastLetter = inputString2.charCodeAt(inputString2.length - 1);
let middleLetter = inputString2.slice(1, -1);
let swappedString =String.fromCharCode(lastLetter) + middleLetter + String.fromCharCode(firstLetter); // Your code here
